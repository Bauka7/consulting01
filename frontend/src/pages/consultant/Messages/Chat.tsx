...
export default function ConsultantChat() {
  ...
  const backPath = '/consultant/messages'
  const requestPath = conversation ? `/consultant/requests/${conversation.requestId}` : '#'
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 px-4 py-3.5 border-b border-[#E8ECF0] bg-white flex-shrink-0">
        <Link to={backPath} className="text-[#718096] hover:text-[#0C1426] transition-colors mr-1">
          <ArrowLeft className="w-5 h-5" />
        </Link>
        <div className="w-9 h-9 rounded-full bg-[#E63946] flex items-center justify-center text-white text-sm font-semibold">
